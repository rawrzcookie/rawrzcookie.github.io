...
const equipmentByDamageType = {
  "Heavenly Strike": {
    "Sword": {
      ...
      "Unique": {
        "Name": ["Alpha Heart Blade", "The Retaliator Reforged"],
        "Secondary": ["Heavenly Strike", "Twilight Fairy"]
      },
    },
    "Helmet": {
      "Primary": ["Gunblade"],
    ...
    "Aura": {
      ...
      "Unique": {
        ...
        "Secondary": ["Stage / Titan Skip", "Mana Boost"]
      },
    },
    "Slash": {
      ...
      "Unique": {
        "Name": ["Kronus' Flame"],
        "Secondary": ["Portar", "All Probability"]
      },
    }
  },
  "Pet": {
    "Sword": {
      ...
      "Unique": {
        "Name": ["Alpha Heart Blade", "The Retaliator Reforged"],
        "Secondary": ["Dual Summon", "Fire Sword"]
      },
    },
    "Helmet": {
      ...
      "Unique": {
        "Name": "Elder Snow Cap",
        "Secondary": ["Pet", "All / Critical Damage"]
      },
    },
    "Aura": {
      "Primary": ["Sword", "Slash"],
      "Secondary": ["Stage / Titan Skip", "Mana Boost", "Multiple Fairy"],
      "Unique": {
        "Name": ["Sophia's Faith", "Lightning Metal Wings"],
        "Secondary": ["Stage / Titan Skip", "Mana Boost"]
      },
    },
    "Slash": {
      ...
      "Unique": {
        ...
        "Secondary": ["All Probability", "Critical Chance"]
      },
    }
  },
  "Clan Ship": {
    "Sword": {
      ...
      "Unique": {
        "Name": ["Alpha Heart Blade", "The Retaliator Reforged"],
        "Secondary": ["War Cry", "Thunder Ship"]
      },
    },
    "Helmet": {
      "Primary": ["Highest Hero"],
      ...
      "Unique": {
        "Name": ["Elder Snow Cap"],
        "Secondary": ["Clan Ship", "All / Critical Damage"]
      },
    },
    "Aura": {
      ...
      "Secondary": ["Stage / Titan Skip", "Mana Boost", "Multiple Fairy"],
      "Unique": {
        "Name": ["Sophia's Faith", "Gulbrand's Rally"],
        "Secondary": ["Stage / Titan Skip", "Mana Boost"]
      },
    },
    "Slash": {
  ...
  "Shadow Clone": {
    "Sword": {
      ...
      "Unique": {
        "Name": ["Alpha Heart Blade", "The Retaliator Reforged"],
        "Secondary": ["Shadow Clone", "Twilight Fairy"]
      },
    },
    "Helmet": {
      ...
      "Unique": {
        "Name": ["Elder Snow Cap"],
        "Secondary": ["All Damage", "Critical Damage"]
      },
    },
    "Aura": {
      "Primary": ["Sword", "Slash"],
  ...
  "Dagger": {
    "Sword": {
      ...
      "Unique": {
        "Name": ["Alpha Heart Blade", "The Retaliator Reforged"],
        "Secondary": ["Blade Stream", "Fire Sword"]
      },
    },
    "Helmet": {
      "Primary": ["Gunblade"],
      ...
      "Unique": {
        "Name": ["Burden of the Oathkeeper"],
        "Secondary": ["Dagger", "All / Critical Damage"]
      },
    },
    "Aura": {
      "Primary": ["Sword", "Slash"],
  ...
  "Gold Gun": {
    ...
    "Helmet": {
      ...
      "Unique": {
        "Name": ["Elder Snow Cap"],
        "Secondary": ["Gold Gun", "All / Critical Damage"]
      },
    },
    "Aura": {
      "Primary": ["Sword", "Slash"],
...
function updateEquipment() {
  ...
  equipmentItems.forEach(item => {
    ...
    const uniqueNamesContainer = item.querySelector('.equipment-unique-names');
    ...
    if (uniqueNamesContainer) uniqueNamesContainer.textContent = '';
    ...
    if (equipmentType === 'armor') {
      ...
      // Unique armor data
      if (armorData.Unique && uniqueNamesContainer) {
        const names = Array.isArray(armorData.Unique.Name)
          ? armorData.Unique.Name
          : [armorData.Unique.Name];

        names.forEach(name => {
          const nameSpan = document.createElement('span');
          nameSpan.textContent = name;
          uniqueNamesContainer.appendChild(nameSpan);
        });
      ...
      if (equipmentData.Unique && uniqueNamesContainer) {
        const names = Array.isArray(equipmentData.Unique.Name)
          ? equipmentData.Unique.Name
          : [equipmentData.Unique.Name];
